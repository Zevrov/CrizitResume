      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <a href="mailto:wolf.hopkins@gmail.com" className="block text-gray-400 hover:text-white transition-colors">
              wolf.hopkins@gmail.com
            </a>
            <a href="tel:860-819-6996" className="block text-gray-400 hover:text-white transition-colors">
              860-819-6996
            </a>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Wolf Hopkins. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
